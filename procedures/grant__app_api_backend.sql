...
BEGIN
    ...
    GRANT EXECUTE ON PROCEDURE `app_backend__currency_exchange_rate__insert` TO 'internal'@'localhost';
    GRANT EXECUTE ON PROCEDURE `app_backend__dict_country__get` TO 'internal'@'localhost';
    GRANT EXECUTE ON PROCEDURE `app_backend__dict_currency__get` TO 'internal'@'localhost';
    ...
    GRANT EXECUTE ON PROCEDURE `app_backend__user_order__get_email_send` TO 'internal'@'localhost';
    GRANT EXECUTE ON PROCEDURE `app_backend__user_order__get_products` TO 'internal'@'localhost';
    ...
    GRANT EXECUTE ON PROCEDURE `app_backend__user_support__insert` TO 'internal'@'localhost';

    GRANT EXECUTE ON PROCEDURE `app_backend__currency_exchange_rate__insert` TO 'app_api_backend'@'localhost';
    GRANT EXECUTE ON PROCEDURE `app_backend__dict_country__get` TO 'app_api_backend'@'localhost';
    GRANT EXECUTE ON PROCEDURE `app_backend__dict_currency__get` TO 'app_api_backend'@'localhost';
    ...
    GRANT EXECUTE ON PROCEDURE `app_backend__user_order__get_email_send` TO 'app_api_backend'@'localhost';
    GRANT EXECUTE ON PROCEDURE `app_backend__user_order__get_products` TO 'app_api_backend'@'localhost';
    ...
    GRANT EXECUTE ON PROCEDURE `app_backend__user_support__insert` TO 'app_api_backend'@'localhost';
